    ...
    <section id="contact" className="py-20 bg-gray-900/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-bold mb-4">Connect with NEXOVGEN</h2>
          <p className="text-gray-400 max-w-2xl mx-auto">
            Interested in partnership, collaboration, investment, or learning more about NEXOVGEN's solutions? Let's connect.
          </p>
        </div>
